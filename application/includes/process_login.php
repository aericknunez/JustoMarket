...
if (isset($_POST['email'], $_POST['password'])) {
    ...
    if ($seslog->LogOn($email, $password) == true) {
        // Login success 
         echo '<div class="inline-ul text-center d-flex justify-content-center"><img src="'. BASE_URL .'assets/img/loading (1).gif"></div>';
         echo '<script>
        ...
        echo '<script>
            window.location.href="'. BASE_URL .'error.php?err=No se puede iniciar"
        </script>';
