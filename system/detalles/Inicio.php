    ...
    '. Helpers::Dinero($datos["precio"]) .'
        ...
        echo '<div class="row no-gutters align-items-center">
                    <div class="col-3 text-right nopadding">
                        <a id="accion-producto" iden="'.$datos["cod"].'" accion="1" lugar="'.$rand.'" cantidad="'.$datos["cantidad"].'" ilimitado="'.$datos["ilimitado"].'"><i class="fa fa-minus-circle fa-lg naranja p-1 border-0"></i></a>
                    </div>
...
z-depth-1 rounded-pill mt-0 w-75 text-center border-0" value="1"></input>
                    ...
                    <div class="col-3 text-left nopadding">
                        <a id="accion-producto" iden="'.$datos["cod"].'" accion="2" lugar="'.$rand.'" cantidad="'.$datos["cantidad"].'" ilimitado="'.$datos["ilimitado"].'"><i class="fa fa-plus-circle fa-lg naranja p-1 border-0"></i></a>
                    </div>
                </div>
